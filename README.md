...
- Finally, run the script to generate token file `token.pickle` for Google Drive:
        ...
        - Command-1: `pip install google-api-python-client google-auth-httplib2 google-auth-oauthlib`
        - Command-2: `python3 generate_drive_token.py`
